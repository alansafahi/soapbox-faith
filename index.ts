...
const TOOLS = [
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        consent_token: { type: "string", description: "Opaque SoapBox consent token with the 'prayer:write' scope, generated by the user in the SoapBox app. An invalid, expired, or wrong-scope token returns an authorization error.", minLength: 16, examples: ["sbxpr_9f3a2b7c4d5e6f7a…"] },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        consent_token: { type: "string", description: "The same user's SoapBox consent token (scope 'prayer:write') used when the prayer was submitted. Only returns status for that user's own prayers.", minLength: 16, examples: ["sbxpr_9f3a2b7c4d5e6f7a…"] },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        consent_token: { type: "string", description: "Opaque SoapBox consent token with the 'giving:write' scope, bound to your agent key and carrying the user's pre-authorized per-gift and monthly caps. Generated by the user in the SoapBox app.", minLength: 16, examples: ["sbxgv_9f3a2b7c4d5e6f7a…"] },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        consent_token: { type: "string", description: "Opaque SoapBox consent token with the 'context:read' scope, bound to your agent key. The user generates it in the SoapBox app. Returns only the user's declared profile (denomination, preferred language, faith journey, ministry interests) — never their private prayers or journal. An invalid, expired, or wrong-scope token returns an authorization error.", minLength: 16, examples: ["sbxctx_9f3a2b7c4d5e6f7a…"] },
      },
